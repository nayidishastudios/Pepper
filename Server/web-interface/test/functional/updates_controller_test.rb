...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { commit_id: @update.commit_id, level: @update.level, repository_id: @update.repository_id, type: @update.type, type_id: @update.type_id }
    end
  ...
  test "should update update" do
    put :update, id: @update, update: { commit_id: @update.commit_id, level: @update.level, repository_id: @update.repository_id, type: @update.type, type_id: @update.type_id }
    assert_redirected_to update_path(assigns(:update))
  end
