...
class CommitsControllerTest < ActionController::TestCase
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post :create, commit: { commit_hash: @commit.commit_hash, is_update: @commit.is_update, message: @commit.message, repository_id: @commit.repository_id, time: @commit.time }
    end
  ...
  test "should update commit" do
    put :update, id: @commit, commit: { commit_hash: @commit.commit_hash, is_update: @commit.is_update, message: @commit.message, repository_id: @commit.repository_id, time: @commit.time }
    assert_redirected_to commit_path(assigns(:commit))
  end
